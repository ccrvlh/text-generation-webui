...
def llamacpp_loader(model_name):
    from app.loaders.llama_cpp import LlamaCppModel
...
def llamacpp_HF_loader(model_name):
    from app.loaders.llama_cpp_hf import LlamacppHF
...
def AutoGPTQ_loader(model_name):
    from app.loaders import gptq_auto

    return gptq_auto.load_quantized(model_name)


def ExLlama_loader(model_name):
    from app.loaders.exllama import ExllamaModel
...
def ExLlama_HF_loader(model_name):
    from app.loaders.exllama_hf import ExllamaHF
