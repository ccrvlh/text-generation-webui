...
parser.add_argument(
    "--verbose", action="store_true", help="Print the prompts to the terminal."
)
...
parser.add_argument(
    "--no-mmap", action="store_true", help="Prevent mmap from being used."
)
...
parser.add_argument(
    "--n_ctx", type=int, default=2048, help="Size of the prompt context."
)
parser.add_argument(
    "--llama_cpp_seed",
    type=int,
...
parser.add_argument(
    "--max_seq_len", type=int, default=2048, help="Maximum sequence length."
)
parser.add_argument(
    "--compress_pos_emb",
    type=int,
...
if args.multi_user:
    logger.warning(
        "The multi-user mode is highly experimental. DO NOT EXPOSE IT TO THE INTERNET."
    )
